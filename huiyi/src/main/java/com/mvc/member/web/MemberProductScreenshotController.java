...
@Controller
@RequestMapping("/member/productScreenshot")
public class MemberProductScreenshotController {
    ...
    public String uploadProduct(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (StringUtils.isNotBlank(fileName) && fileName.endsWith(".jpg")) {
            ...
            String message = I18NUtils.transformName("图片格式必须为.jpg", "Picture format must be.Jpg", request.getLocale());
