	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
							...
							<div class="form-group">
								<label for="itemId" class="col-sm-2 control-label">名称:</label>
									<div id="optionD" class="col-sm-10">
										 <select name="itemId"style="width: 325px;background-color: white;"  >
				                            <option value="">请选择</option>
			...
			<div id="productD" hidden="true">
				<select name="itemId"  class="js-example-placeholder-single" style="width: 325px;background-color: white;">
				         <option value="">请选择</option>
				           <jdf:selectCollection items="products" optionValue="objectId" optionText="nameZh" />
				 </select>
				 <input type="hidden" name="biaoqian" value="1">
			</div>
			<!-- 产品2 -->
			<div id="companiesD" hidden="true">
				...
				<input type="hidden" name="biaoqian" value="2">
			</div>
