...
<title>产品分类属性设置</title>
</head>
<body>
        <div class="panel panel-default">
        <div class="panel-heading">
            <span class=""></span>产品分类属性设置
            <div class="pull-right">
                 <a href="${dynamicDomain}/admin/attribute/create?ajax=1&categoryId=${param.categoryId}" class="colorbox pull-left btn btn-primary">
        ...
        <div class="panel-body">
            ...
            <form action="${dynamicDomain}/admin/attribute/page?categoryId=${param.categoryId}" method="post" class="form-horizontal">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                <label for="search_LIKES_nameZh" class="col-sm-3 control-label">属性名：</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="search_LIKES_nameZh">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                <label for="search_EQI_type" class="col-sm-3 control-label">属性类型：</label>
                                <div class="col-sm-6">
            ...
            <div id="tableDiv" class="row">
                <div class="col-sm-12 col-md-12">
                    <jdf:table items="items" var="currentRowObject" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" action="${dynamicDomain}/admin/attribute/page?categoryId=${param.categoryId}">
                        <jdf:export view="csv" fileName="产品分类属性设置.csv" tooltip="导出CSV" imageName="csv" />
                        <jdf:export view="xls" fileName="产品分类属性设置.xls" tooltip="导出EXCEL" imageName="xls" />
                        <jdf:row>
                            ...
                            <jdf:column alias="操作" title="common.lable.operate" sortable="false" viewsAllowed="html" style="width: 4%">
                                <a href="${dynamicDomain}/admin/attribute/edit/${currentRowObject.objectId}?ajax=1&categoryId=${param.categoryId}" class="btn btn-primary btn-mini colorbox">编辑属性
                                </a>
                            </jdf:column>
                            <jdf:column property="rowcount" sortable="false" cell="rowCount" title="序号" style="width:4%;text-align:center"/>
                            <jdf:column property="nameZh" title="属性名称" headerStyle="width:10%;" />
                            <jdf:column property="valueNames" title="属性值" headerStyle="width:30%;" />
                            ...
                            <jdf:column property="type" title="属性类型" headerStyle="width:10%;">
                              <jdf:columnValue dictionaryId="1501" value="${currentRowObject.type}" />
                            </jdf:column>
        ...
        function saveSortNo(){
            ...
            $.ajax( {
                url : "${dynamicDomain}/admin/attribute/saveSortNos",
                type : 'post',
                dataType : 'json',
