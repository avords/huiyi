...
<title><jdf:message code="system.lable.role.config_menu"/></title>
</head>
<body>
	<div class="panel panel-default">
		<div class="panel-heading">
			<span class="glyphicon glyphicon-edit"></span><jdf:message code="system.lable.role.config_menu"/>(${role.name})
		</div>
		<div class="panel-body">
			<form action="${dynamicDomain}/admin/role/saveRoleMenu?ajax=1" method="post" name="UserRole" id="UserRole" class="form-horizontal" onsubmit="prepare();">
						...
						<div class="form-group">
							<label for="name" class="col-sm-6 control-label">
								<select name="menuId" id="selected" multiple="multiple" style="width: 300px;" size="15">
									<jdf:selectCollection items="haveMenus" optionValue="objectId" optionText="path"/>
								</select>
							</label>
						</div>
					</div>
						...
						<div class="form-group">
							<label for="name" class="col-sm-6 control-label">
								<select name="unSelected" id="unSelected" multiple="multiple" style="width: 300px;" size="15">
									<jdf:selectCollection items="notHaveMenus" optionValue="objectId" optionText="path"/>
								</select>
							</label>
						</div>
					</div>
