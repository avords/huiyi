...
<body>
	<div class="editForm">
		...
		<div class="content" id="order">
			<jdf:form bean="request" scope="request">
				<form action="${dynamicDomain}/admin/fileStrategy/page" method="post">
					<ul>
						<li>
	...
	<div class="rightToolBar">
		<a href="${dynamicDomain}/admin/fileStrategy/create" class="button">增加</a>
	</div>
	<div id="tableDiv">
		<jdf:table items="items"  retrieveRowsCallback="limit" var="fileStrategy" filterRowsCallback="limit" sortRowsCallback="limit" action="page">
			...
			<jdf:row>
				...
				<jdf:column alias="操作" sortable="false" viewsAllowed="html" style="width: 10%">
					<a href="${dynamicDomain}/admin/fileStrategy/edit/${fileStrategy.objectId}">修改</a>
					<a href="#" onclick="toDeleteUrl('${dynamicDomain}/admin/fileStrategy/delete/${fileStrategy.objectId}')">删除</a>
				</jdf:column>
			</jdf:row>
		</jdf:table>
	</div>
