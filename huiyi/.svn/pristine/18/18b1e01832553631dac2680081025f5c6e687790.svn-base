	              ...
	              <c:forEach items="${pageSearch.list}" var="asl">
	                <div class="list clearfix">
	                  <div class="cont">
	                    ...
	                    <p style="white-space: nowraplabel_mytracks_company_natureverflow: hidden; text-overflow: ellipsis"><i><jdf:message code="main_product"/>：</i>${asl.entity.mainProductsZh}</p>
