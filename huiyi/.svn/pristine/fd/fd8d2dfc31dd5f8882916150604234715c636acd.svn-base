...
<body>
    <div class="panel panel-default">
        <div class="panel-heading">
            <span class="menu-icon glyphicon glyphicon-align-left icon-white"></span>产品审核
                <c:choose>
        ...
        <div class="panel-body">
            <jdf:form bean="entity" scope="request">
                <form method="post" action="${dynamicDomain}/admin/product/save" class="form-horizontal" id="category">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    ...
                                                    <a href="${dynamicDomain }/admin/company/companyTemplate?inputName=supplier&ajax=1" class="btn btn-primary colorbox">请选择</a>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <c:forEach items="${qualificationDic }" var="item" varStatus="status">
                                        <div class="row">
                                            ...
                                            <input style="width:75%;" type="text" id="qualificationRemark_${item.value }" name="qualificationRemark_${item.value }">
                                        </div>
                                    </c:forEach>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="rmbPrice">
                                 <jdf:message code="人民币单价 " />
                                  </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="rmbPrice">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="usdPrice">
                                 <jdf:message code="美元单价 " />
                                  </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="usdPrice">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <table border="1" style="width: 100%;">
                                  <thead>
                                     <tr>
                                         <th width="15%">操作</th><th width="10%">状态</th><th width="15%">产品编号</th><th width="15%">中文属性值</th><th width="15%">英文属性值</th><th width="15%">人民币单价</th><th width="15%">美元单价</th>
                                     </tr>
                                  </thead>
                                  <tbody id="skuBody">
                                        <c:forEach items="${skus }" var="item" varStatus="status">
                                          <tr>
                                            ...
                                            <td>
                                               <c:if test="${item.status==2}">
	                                               <button type="button" class="sku-pass" data-id="${item.objectId }">审核通过</button>
	                                                <a href="${dynamicDomain}/admin/sku/checkNotPass/${item.objectId}?ajax=1" class="colorbox-define sku-not-pass" style="color: black;">
                                            ...
                                            <td><input name="sellPriceZh" value="${item.sellPriceZh }"></td>
                                            <td><input name="sellPriceEn" value="${item.sellPriceEn }"></td>
                                        </tr>
                                      </c:forEach>
                                  </tbody>
                                </table>
...
<!--                         </div> -->
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="pull-right">
                                <a class="btn btn-primary group-pass" href="javascript:void(0);">
                                    <span class="glyphicon glyphicon-ok"></span>整组审核通过
                                </a>
                                <a href="${dynamicDomain}/admin/product/checkNotPass/${entity.objectId}?ajax=1" class="colorbox-define btn btn-primary check-not-pass" style="color: black;">
                                    <span class="glyphicon glyphicon-remove"></span>整组审核不通过
                                </a>
                                <a href="${dynamicDomain }/sku/checkPage">返回</a>
                            </div>
                        </div>
                    </div>
                    </div>
            ...
            for(var i in vId){
                ...
                '<tr>'+
                   ...
                   '<td>'+
                       vNameEn[i]+
                   '</td>'+
                   '<td><input name="sellPriceZh" value="'+sellPriceZh+'"></td>'+
                   '<td><input name="sellPriceEn" value="'+sellPriceEn+'"></td>'+
               '</tr>';
            }
    ...
    $(function(){
        ...
        $('.group-pass').click(function(){
            $.ajax({
                url:"${dynamicDomain}/admin/product/checkPass/${entity.objectId}",
                type : 'post',
                dataType : 'json',
                success : function(json) {
                    alert(json.message);
                    if(json.result){
                        var url = '${dynamicDomain}/admin/sku/checkPage';
        ...
        $('.sku-pass').click(function(){
            var id = $(this).data('id');
            $.ajax({
                url:"${dynamicDomain}/admin/sku/checkPass/"+id,
                type : 'post',
                dataType : 'json',
                success : function(json) {
                    alert(json.message);
