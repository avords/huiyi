			...
			<div class="tab-page" id="tabPage1">
				...
				<div class="contentborder tableForm">
					<jdf:form bean="entity" scope="request">
						<form action="${dynamicDomain}/admin/fileStrategy/save" method="post">
								...
								<tr>
									<td class="bottomLabel" nowrap colspan="4">
										<div class="pull-right">
											...
											<button type="button" onclick="toUrl('${dynamicDomain}/admin/fileStrategy/create')">继续增加</button>
											</c:if>
											<button type="button" id="delete" onclick="toDeleteUrl('${dynamicDomain}/admin/fileStrategy/delete/${entity.objectId}')">删除</button>
											<button type="button" onclick="toUrl('${dynamicDomain}/admin/fileStrategy/page')">返回</button>
										</div>
									</td>
								</tr>
							</table>
