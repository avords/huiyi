...
<body>
    <div class="panel panel-default">
        <div class="panel-heading">
            <span class="menu-icon glyphicon glyphicon-align-left icon-white"></span>>产品运营二级分类
                <c:choose>
        ...
        <div class="panel-body">
            <jdf:form bean="entity" scope="request">
                <form method="post" action="${dynamicDomain}/admin/category/save?ajax=1" class="form-horizontal" id="category">
                    ...
                    <input type="hidden" name="type" value="${parentCategory.type }">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="nameZh">
                                 <jdf:message code="二级分类中文名称 " />
                                  </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="nameZh">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="pull-right">
                                <button  onclick="closeBox();" class="btn btn-primary" type="submit">
