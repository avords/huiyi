...
<title><jdf:message code="服务审核中心"/></title>
</head>
<body>
	 <div class="panel panel-default">
		<div class="panel-heading">
			<span class="menu-icon glyphicon glyphicon-align-left icon-white"></span><jdf:message code="服务审核中心"/>
		</div>
					...
					<jdf:table items="items" retrieveRowsCallback="limit" var="currentRowObject" filterRowsCallback="limit" sortRowsCallback="limit" action="page">
						...
						<jdf:row>
							...
							<jdf:column alias="common.lable.operate" title="common.lable.operate" sortable="false" viewsAllowed="html" style="width: 40%;">
								...
								<a href="javascript:;" class="btn btn-primary btn-mini" onclick="confirm3('${dynamicDomain}/admin/service/handelStatus/${currentRowObject.objectId}?status=3');">
	                            	<span class="glyphicon glyphicon-check"></span><jdf:message code="审核通过"/>
	                            </a>
								<a href="javascript:;" class="btn btn-danger btn-mini" onclick="confirm4('${dynamicDomain}/admin/service/handelStatus/${currentRowObject.objectId}?status=4');">
	                            	<span class="glyphicon glyphicon-check"></span><jdf:message code="审核不通过"/>
	                            </a>
							</jdf:column>
						</jdf:row>
					</jdf:table>
	...
	function confirm4(url){
	    var r=confirm("确定要审核不通过吗?");
	    if (r==true){
	      window.location.href=url;
	    }else{
	      }
