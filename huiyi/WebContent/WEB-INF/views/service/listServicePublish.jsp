...
<title><jdf:message code="服务发布中心"/></title>
</head>
<body>
	 <div class="panel panel-default">
		<div class="panel-heading">
			<span class="menu-icon glyphicon glyphicon-align-left icon-white"></span><jdf:message code="服务发布中心"/>
		</div>
					...
					<jdf:table items="items" retrieveRowsCallback="limit" var="currentRowObject" filterRowsCallback="limit" sortRowsCallback="limit" action="page">
						...
						<jdf:row>
							...
							<jdf:column alias="common.lable.operate" title="common.lable.operate" sortable="false" viewsAllowed="html" style="width: 40%;">
								...
								<a href="javascript:;" class="btn btn-primary btn-mini" onclick="confirm5('${dynamicDomain}/admin/service/handelStatus/${currentRowObject.objectId}?status=5');">
	...
	function confirm5(url){
	    var r=confirm("确定要发布吗?");
	    if (r==true){
