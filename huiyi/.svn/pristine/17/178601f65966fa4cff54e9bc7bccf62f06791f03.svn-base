...
<body>
        ...
        <div class="panel-heading">
            <span class=""></span>产品运营二级分类
            <div class="pull-right">
                 <a href="${dynamicDomain}/admin/category/secondCreate?ajax=1&parentId=${param.parentId}" class="colorbox pull-left btn btn-primary">
        ...
        <div class="panel-body">
            ...
            <form action="${dynamicDomain}/admin/category/secondPage?parentId=${param.parentId}" method="post" class="form-horizontal">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                <label for="search_LIKES_name" class="col-sm-3 control-label">二级分类名称：</label>
                                <div class="col-sm-6">
                        ...
                        <div class="col-sm-12  col-md-12">
                            ...
                            <div class="pull-right">
                                ...
                                <button type="submit" class="btn  btn-primary">
                                    <span class="glyphicon glyphicon-back"></span><jdf:message code="common.button.query" />
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div id="tableDiv" class="row">
                <div class="col-sm-12 col-md-12">
                    <jdf:table items="items" var="currentRowObject" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" action="${dynamicDomain}/admin/category/secondPage?parentId=${param.parentId}">
                        <jdf:export view="csv" fileName="产品运营二级分类.csv" tooltip="导出CSV" imageName="csv" />
                        <jdf:export view="xls" fileName="产品运营二级分类.xls" tooltip="导出EXCEL" imageName="xls" />
                        <jdf:row>
                            ...
                            <jdf:column alias="操作" title="common.lable.operate" sortable="false" viewsAllowed="html" style="width: 4%">
                                <a href="${dynamicDomain}/admin/category/editSecond/${currentRowObject.objectId}?ajax=1&parentId=${param.parentId}" class="btn btn-primary btn-mini colorbox"> 
                                    <i class="glyphicon glyphicon-pencil"></i>
                                </a>
                            </jdf:column>
                            <jdf:column property="rowcount" sortable="false" cell="rowCount" title="序号" style="width:4%;text-align:center"/>
                            <jdf:column property="nameZh" title="二级分类名称" headerStyle="width:20%;" />
                    ...
                    <div class="pull-right">
                          <button type="button" class="btn btn-primary pull-left" onclick="javascript:window.history.go(-1);">
