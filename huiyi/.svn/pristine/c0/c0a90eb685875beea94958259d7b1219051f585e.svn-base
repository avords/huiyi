...
<!--  ************************************分页 *************************************	-->
			...
			<input type="hidden" name="ec_crd" value="8" />
...
<!--  ************************************排序 *************************************	-->
			...
			<tr>
				<td align='left'>&nbsp;
						<c:if test="${fn:length(items)>0}">
							<font color='#000000'>共${totalRows}条记录，分${maxPage}页显示</font> &nbsp;
							第<input id="page"  name="page" onkeypress="if(event.keyCode==13) {toPage($('#page').val());};" style="width: 18px;text-align: center" value="${page }">页
		...
		<jdf:themeFile file="pageListResource.js" />