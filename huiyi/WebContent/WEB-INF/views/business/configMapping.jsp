...
<body>
	<div class="panel panel-default">
		<div class="panel-heading">
			<span class="glyphicon glyphicon-th"></span>${mallCategory.nameZh}关联产品分类
			<div class="pull-right">
			</div>
		</div>
		<div class="panel-body">
			<jdf:form bean="entity" scope="request">
				<form method="post" action="${dynamicDomain}/admin/mallCategory/saveMapping/${objectId}?ajax=1" class="form-horizontal" id="form">
					<div class="row">
