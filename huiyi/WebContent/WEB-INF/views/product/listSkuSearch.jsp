...
<body>
        ...
        <div class="panel-heading">
            <span class=""></span>产品查询
            <div class="pull-right">
            </div>
        </div>
        <div class="panel-body">
            <jdf:form bean="request" scope="request">
            <form action="${dynamicDomain}/admin/sku/search" method="post" class="form-horizontal">
                    <div class="row">
            ...
            <div id="tableDiv" class="row">
                <div class="col-sm-12 col-md-12">
			        <jdf:table items="items" var="currentRowObject" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" action="${dynamicDomain}/admin/sku/search">
